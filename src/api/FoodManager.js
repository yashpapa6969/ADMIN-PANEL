...
function FoodManagerTable() {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        "https://l4ts4vhb71.execute-api.us-east-1.amazonaws.com/api/superAdmin/getAllFoodMangaer/"
      );
      ...
      setFoodManagers(data.foodManager);
    } catch (error) {
  ...
  const handleConfirmDelete = async () => {
    try {
      const response = await fetch(
        `https://l4ts4vhb71.execute-api.us-east-1.amazonaws.com/api/superAdmin/DeletefoodManagerById/${deleteFoodManagerId}`,
        {
          method: "DELETE",
        }
      );
  ...
  const handleAddFoodManager = async (newManager) => {
    try {
      const response = await fetch(
        "https://l4ts4vhb71.execute-api.us-east-1.amazonaws.com/api/superAdmin/setFoodManager",
        {
          method: "POST",
          headers: {
    ...
    <Box pt="4">
      <VStack align="stretch" spacing="4">
        ...
        <Modal isOpen={isOpenAddFoodManager} onClose={onCloseAddFoodManager}>
          ...
          <ModalContent>
            {" "}
            <ModalHeader>Add Food Manager</ModalHeader>
            <ModalCloseButton />
            <ModalBody>
              <FormControl>
          ...
          >
            <AlertDialogOverlay>
              <AlertDialogContent>
                ...
                <AlertDialogBody>
                  Are you sure you want to delete this food manager? This action
                  cannot be undone.
                </AlertDialogBody>
                <AlertDialogFooter>
...
export default FoodManagerTable;
